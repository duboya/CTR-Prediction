...
def preprocess(datadir, outdir, cutoff):
    """
    ...
    # for validation.
    with open(outdir + 'tr.libsvm', 'w') as out_train:
        with open(outdir + 'va.libsvm', 'w') as out_valid:
    ...
    with open(outdir + 'te.libsvm', 'w') as out:
...
if __name__ == "__main__":
    ...
    print('threads ', -1)
    print('input_dir ', './Data/input')
    print('output_dir ', './Data/output')
    print('cutoff ', 200)
    # FLAGS.output_dir = './Data/output'

    preprocess('../Data/input/', '../Data/output/', cutoff=200)
